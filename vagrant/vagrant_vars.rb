module VagrantVars
    $dev_host_name = 'test.dev' #domain that will be used for accessing the machine (the enviroment will be appened to the end of domain and does not need to be a FCDN)
